...
namespace HMT.Areas.Admin.Controllers
{
    ...
    public class VendorsController : Controller
    {
        ...
        public VendorsController(HMTContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VendorID,Name")] Vendor vendor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendorID,Name")] Vendor vendor)
        {
